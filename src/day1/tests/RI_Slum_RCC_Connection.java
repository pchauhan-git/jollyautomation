...
public class RI_Slum_RCC_Connection {
...
@Test
    ...
    ExtentTest test = extent.createTest("Test to Create new R1 Slum RCC Type Connection");
        homePage = loginPg.login("swengp@gmail.com","Saltoris@123");
        //Assert.assertTrue(homePage.verifyHomePageLoaded());
        homePage.createNewConnectionR1SlumRCC();
    test.pass("Connection applied R1 Slum hut");
